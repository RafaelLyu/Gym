import { View, Text, TextInput, Button, StyleSheet , Image } from 'react-native'; // Importe Button de 'react-native'
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.introducao}>
                ...
                <Text style={styles.SubTextintroducao}>Sua Jornada Começa Aqu</Text>
            </View>
