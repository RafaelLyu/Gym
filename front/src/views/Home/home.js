...
export default function HomeScreen() {
  ...
  const series = [
    { id: 1, name: 'Série A', exercises: [
        { id: 1, name: 'Exercício A1', repeticao:'20' },  
        { id: 2, name: 'Exercício A2', repeticao:'20' }] 
    },
    { id: 2, name: 'Série B', exercises: [
        { id: 3, name: 'Exercício B1', repeticao :'20'}, 
        { id: 4, name: 'Exercício B2', repeticao : '20' }] 
    },
    { id: 3, name: 'Série C', exercises: [
        { id: 5, name: 'Exercício C1',  repeticao:'20' }, 
        { id: 6, name: 'Exercício C2', repeticao:'20' },
        { id: 6, name: 'Exercício C2',  repeticao:'20' },
        { id: 6, name: 'Exercício C2', repeticao:'20' },
        { id: 6, name: 'Exercício C2', repeticao:'20' }] 
    },
